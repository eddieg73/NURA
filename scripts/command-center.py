...
def medisun_fleet():
    """The Medisun MIH fleet — an operational register numbered by fire-dept service area.
    This mirrors the authoritative vault register (REG-MIH-001), surfaced for a glance.""" 
    return [
        ("MIH-04-C", "Lauderhill/Fort Lauderdale Fire", "Broward", "MIH Clinic (NP, no lights)", "Phase-1 launch"),
        ("MIH-05-A", "Lauderhill/Fort Lauderdale Fire", "Broward", "ALS Non-Transport (paramedic)", "Phase-1 launch"),
        ("MIH-06-C", "Miami-Dade Fire Rescue St-49", "Miami-Dade", "MIH Clinic (NP, no lights)", "Affiliate staged"),
        ("MIH-07-C", "Tampa Fire Rescue", "Hillsborough", "MIH Clinic (NP, no lights)", "Affiliate staged"),
        ("MIH-08-A", "Tampa Fire Rescue", "Hillsborough", "ALS Non-Transport (paramedic)", "Affiliate staged"),
        ("MIH-01-C", "City of Miami Fire", "Miami-Dade", "MIH Clinic (NP, no lights)", "Staged/assign"),
        ("MIH-02-C", "City of Miami Fire", "Miami-Dade", "MIH Clinic (NP, no lights)", "Staged/assign"),

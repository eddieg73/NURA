...
from .schemas import ClinicalOutput, DifferentialItem, ProvenanceItem


SYSTEM_INSTRUCTIONS = """
You are a clinician decision-support drafting service. You do not establish a diagnosis,
issue treatment orders, or replace the accountable clinician. Work only from the supplied

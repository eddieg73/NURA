...
>
> Companion: vault `Aero/EMS-Drone-Spec.md` (technical system spec) · `drones/drone-swarm-division` skill (swarm doctrine).
...
| **B — Blood** | Whole blood / PRBC / plasma / components | 2–8°C, validated, chain-of-custody, temp live-streamed (breach = abort/replace) | O-neg first-line; blood-bank (AABB) protocol | **Proven in FL now** |

              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Tasks are stored in your organization-scoped backend. Email, SMS, fax, payment, and EHR connectors remain disabled until each service is approved, authenticated, and audited.',
                    ),
                    const SizedBox(height: 12),
                    Wrap(
                      spacing: 8,

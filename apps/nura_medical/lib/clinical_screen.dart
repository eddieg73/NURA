          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Not for emergency communication. For an emergency, activate the appropriate emergency response system. NURA output is decision-support draft material only.',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_history.isEmpty)
                      const Text('No drafts are available for this account.')
                    else

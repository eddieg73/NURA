...
class NuraMedicalAppStoreApp extends ConsumerWidget {
  const NuraMedicalAppStoreApp({super.key});
...
class _AppStoreHome extends StatefulWidget {
  const _AppStoreHome({required this.user});

  final AppUser user;

  @override
  State<_AppStoreHome> createState() => _AppStoreHomeState();
}

class _AppStoreHomeState extends State<_AppStoreHome> {
  int _tab = 0;
  ...
  Widget build(BuildContext context) {
    ...
    if (_tab >= screens.length) _tab = screens.length - 1;
    return Scaffold(
